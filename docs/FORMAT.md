...
| 11 | Picture tube (read and written; File > Export > Picture Tube) | chunk `{len=30, u16 0, step u32, columns u32, rows u32, total cells u32, placement u32, selection u32}`; placement 1 random / 2 continuous, selection 1 random / 2 incremental / 3 angular / 4 pressure / 5 velocity; cells are the image divided into columns x rows |
